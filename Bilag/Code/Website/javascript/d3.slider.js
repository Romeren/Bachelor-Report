      ...
      function moveHandle(pos) {
        ...
        if (value !== newValue) {
          ...
          if (animate) {
           ...
           //HACKING AND DEEBUGGIN .... Their script does not work... so i have fixed it #ROMEREN ! ;P
            ...
            //
            //hest = handle;
            if(position == 'bottom') handle[0][0].style.setProperty('bottom', newPos);
            else handle[0][0].style.setProperty('left', newPos);
            //handle.transition()
            //    .styleTween(position, function() {console.log('trans'); return d3.interpolate(oldPos, newPos); })
